...
def SalvarVinculo():
    ...
    try:
        if Tipo == 'Grupo':
            ...
            if Acao == 'Adicionar' and not Vinculo: Sessao.add(Tb_PermissaoGrupo(Codigo_UsuarioGrupo=IdAlvo, Id_Permissao=IdPermissao))
            ...
            if Acao == 'Resetar': 
                ...
                if not Vinculo: Sessao.add(Tb_PermissaoUsuario(Codigo_Usuario=IdAlvo, Id_Permissao=IdPermissao, Conceder=Estado))
