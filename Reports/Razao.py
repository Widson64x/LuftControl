...
class RazaoReport:
    ...
    def get_dados(self, page=1, per_page=50, search_term='', view_type='original'):
        ...
        ajustes_edicao = {}
        if view_type == 'adjusted': 
            ajustes_edicao = self._get_ajustes_edicao()
    ...
    def get_resumo(self, view_type='original'):
        if view_type == 'adjusted':
            sql = text("""
    ...
    def export_full(self, search_term='', view_type='original'):
        params = {}
